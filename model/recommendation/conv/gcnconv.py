...
class GCNLightConv(MessagePassing):
...
if __name__=='__main__':
    conv = GCNLightConv(in_channels=128, out_channels=128)
    print(conv(torch.rand(5,128), edge_index=torch.tensor([[1,2], [0,1]]), edge_weight=[1,3]))