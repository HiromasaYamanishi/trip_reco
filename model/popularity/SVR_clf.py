...
if __name__ == '__main__':
    ...
    train_mask=np.load('/home/yamanishi/project/trip_recommend/model/popularity_final/data/train_mask.npy')
    val_mask=np.load('/home/yamanishi/project/trip_recommend/model/popularity_final/data/valid_mask.npy')
    test_mask =np.load('/home/yamanishi/project/trip_recommend/model/popularity_final/data/test_mask.npy')
