...
if __name__ == '__main__':
    df = pd.read_csv('/home/yamanishi/project/trip_recommend/data/jalan/review/review_all.csv')
    df_exp = pd.read_csv('/home/yamanishi/project/trip_recommend/data/jalan/spot/experience.csv')
    ...
    model.save('/home/yamanishi/project/trip_recommend/data/jalan/graph/ja_review.model')