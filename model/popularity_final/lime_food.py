...
class LIME:
    def __init__(self, data, node_idx, target_edge_type, num_words=15, num_sample=1024, sample=False):
        ...
        self.data_dir = '/home/yamanishi/project/trip_recommend/data/jalan/graph/food'#self.path.data_graph_dir
    ...
    def explain_top(self, model, data, device, explain_num=100):
        ...
        with open('/home/yamanishi/project/trip_recommend/model/popularity_final/data/lime/lime_explain_new_food.csv','a', newline='') as f:
            writer = csv.DictWriter(f, fieldnames=fieldnames)
        ...
        spot_top_idx = np.load('/home/yamanishi/project/trip_recommend/data/jalan/spot/top_food_idx.npy')[:explain_num]
        print(spot_top_idx)
    ...
    def explain_top_test(self, model, data, device, explain_num=100):
        print('explain top')
        fieldnames=['spot_name','gt','pred']
        for i in range(self.num_words):
            fieldnames.append(f'vocab{i}')
        ...
        spot_top_idx = np.load('/home/yamanishi/project/trip_recommend/data/jalan/spot/top_food_test_idx.npy')[:explain_num]
        print(spot_top_idx)
        for node_idx in tqdm(spot_top_idx):
            with open('/home/yamanishi/project/trip_recommend/model/popularity_final/data/lime/lime_explain_new_food.csv','a', newline='') as f:
                writer = csv.DictWriter(f, fieldnames=fieldnames)
...
if __name__=='__main__':
    ...
    model.load_state_dict(torch.load('./data/deepfood.pth'))
    device = 'cuda:1'
    ...
    lime.explain_top_test(model, data, device=device, explain_num=10000)
